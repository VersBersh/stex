...
## Rescue details
- Rescue branch: `rescued/dirty-main-20260324T010519`
- Timestamp: 2026-03-24T01:05:20Z

## Affected files
AA spec/proposal-context-refresh.md

## Diagnostic instructions
1. Inspect the rescue branch. Use the commit hash instead of the branch name if slashes cause issues on Windows:
   - `git log rescued/dirty-main-20260324T010519 --oneline -5`
   - `git diff HEAD..rescued/dirty-main-20260324T010519`
