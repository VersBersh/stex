...
## Rescue details
- Rescue branch: `rescued/dirty-main-20260322T082237`
- Timestamp: 2026-03-22T08:22:40Z

## Affected files
?? .mound/tasks/63/7-struggles.md

## Diagnostic instructions
1. Inspect the rescue branch. Use the commit hash instead of the branch name if slashes cause issues on Windows:
   - `git log rescued/dirty-main-20260322T082237 --oneline -5`
   - `git diff HEAD..rescued/dirty-main-20260322T082237`
